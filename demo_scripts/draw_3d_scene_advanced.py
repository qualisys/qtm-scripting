import demo_scripts.Classes.custom_3d_scene_class
...
def _reload_script_modules():
    ...
    importlib.reload(demo_scripts.Classes.custom_3d_scene_class)
# endregion
...
custom_3d_scene_instance = demo_scripts.Classes.custom_3d_scene_class.custom_3d_scene()
